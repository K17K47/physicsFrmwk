...
g++ -shared -o build/libPhysics.so build/particles/particle.o build/particles/pMngr.o build/particles/pWorld.o build/particles/pForceGens.o build/particles/forceGenerators.o
